...
Es ist deutlich zu erkennen, dass die Bereiche in denen keine Bewegung stattfindet weitgehend richtig detektiert wurden. Und auch die Bewegung des Autos und der Radfahrerin scheinen weitgehend richtig erkannt zu werden. Auffällig ist, dass besonders in  

\begin{minipage}{0.5\textwidth}
	\begin{figure}[H] 
		\includegraphics[bb=0 0 256 256, scale=0.43]{frame43.png}
		\label{fig:frame43}
...
\begin{minipage}{0.5\textwidth}
	\begin{figure}[H] 
		\includegraphics[bb=0 0 256 256, scale=0.43]{frame47.png}
		\label{fig:frame47}
