...
\thispagestyle{empty}
	%\sffamily
			...
			von\\[2ex]
			\begin{tabular}{ll}
			Laura Anger &(Matrikelnr. XXXXXXXX)\\ 
			Timo \dots &(Matrikelnr. XXXXXXXX)\\ 
	...
	Das Projekt beschäftigte sich mit der Bewegungsanalyse einer Videosequenz mit dem Ansatz des Papers von Aach und Kunz\textsuperscript{\cite{aach1998bayesian}}. Es wurde bearbeitet von Laura Anger, Timo \dots und Lukas Kolhagen.
		\subsection{Ansatz im Paper von Aach und Kunz}
	
	\section{Implementierung}
		\subsection{Framework für die Darstellung}
		\subsection{Bewegungsschätzung}
			\subsubsection{Bildrauschen}
			\subsubsection{Örtliche Kohärenz}
			\subsubsection{Zeitliche Kohärenz}
			\subsubsection{Zu minimierende Kostenfunktion}
	\section{Auswertung}
		\subsection{Testvideos}
